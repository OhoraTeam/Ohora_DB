...
--insert문 예시
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, '관리자', 'Q. 회원 탈퇴 방법이 궁금합니다.', SYSDATE, 0, 2, '주문/결제/취소', '이것은 fnp 본문 내용입니다.');



--더미
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 회원 탈퇴 방법이 궁금합니다.', SYSDATE, 0, 2, '사이트 이용', '■ 탈퇴 방법: 홈페이지 로그인 > MY PAGE > (스크롤 하단)회원정보 > 비밀번호 / 비밀번호 확인 입력 > 회원탈퇴 클릭 > 탈퇴 사유 선택후 탈퇴 진행
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤스트립] 어떻게 하면 손톱에 딱 맞는 사이즈를 찾을 수 있나요?', SYSDATE, 0, 2, '상품', '젤스트립은 15종 사이즈 & 30pcs 구성으로 다양한 손톱 사이즈에 사용 가능합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤스트립] 파츠 상품에 동봉되어있는 손톱보호젤은 뭔가요?', SYSDATE, 0, 2, '상품', '손톱보호젤은 파츠로 인해 생길 수 있는 손톱 손상, 기포, 유수분으로부터 손톱을 보호해줍니다.  
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤스트립, 젤네일팁] 베이스젤/탑젤을 사용해도되나요?', SYSDATE, 0, 2, '상품', '베이스젤의 경우 제거 과정에서 손톱 표면과 함께 뜯겨 손톱 손상을 야기할 수 있기에 권장해 드리지 않습니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤스트립] 젤램프로 꼭 경화시켜야하나요?', SYSDATE, 0, 2, '상품', '오호라 젤스트립은 실제 액상 젤을 60%만 굳혀 말랑말랑하게 만든 제품으로 마무리 과정에서 UV LED 젤램프 경화 과정이 꼭 필요합니다. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤램프] 오호라에서 판매중인 젤램프마다 차이는 무엇인가요?', SYSDATE, 0, 2, '상품', '이것은 fnp 본문 내용입니다.');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤스트립] 남은 젤스트립은 어떻게 보관하나요?', SYSDATE, 0, 2, 상품, '젤스트립은 제품 박스 하단의 유통기한까지 사용이 가능합니다. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤스트립] 어떻게 제거해야하나요?', SYSDATE, 0, 2, '상품', '동봉된 우드스틱에 네일 전용 리무버를 충분히 적셔 가장자리부터 결을 따라 부드럽게 밀면서 제거하면 손·발톱 손상을 최소화할 수 있습니다. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤스트립, 젤네일팁] 임산부 / 어린이가 사용해도 되나요?', SYSDATE, 0, 2, '상품', '
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 배송은 얼마나 걸리나요?', SYSDATE, 0, 2, '배송', '배송은 출고일로부터 주말/공휴일 제외 평균 1~3일 정도 소요됩니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 배송비는 얼마인가요?', SYSDATE, 0, 2, '배송', '기본 배송비는 3,000원 이며, 5만원 이상 구매 시 무료배송 됩니다.  

(단, 제주 및 특수 도서 산간 지역은 지역별로 3,000~8,000원의 별도 추가 운임 발생)');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 적립금은 어떻게 사용하나요?', SYSDATE, 0, 2, '사이트 이용', '적립금은 결제페이지에서 적용이 가능합니다. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 쿠폰은 어떻게 사용하나요?', SYSDATE, 0, 2, '사이트 이용', '이것은 fnp 본문 내용입니다.');
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤램프] 오호라에서 판매중인 젤램프마다 차이는 무엇인가요?', SYSDATE, 0, 2, '쿠폰은 결제페이지에서 적용이 가능합니다. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 가상계좌 입금 방법이 어떻게 되나요?', SYSDATE, 0, 2, '사이트 이용', '가상계좌는 아래 방법으로 입금이 가능합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 현금 영수증 발행이 가능한가요?', SYSDATE, 0, 2, '사이트 이용', '가능합니다.

상품 주문 시 결제수단에서 [실시간 계좌 이체] 혹은 [가상계좌]를 선택 후 현금 영수증 신청란에 정보 입력해주시면 해당 정보로 현금 영수증이 발생됩니다.');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 신규 회원 가입 시 혜택이 있나요?', SYSDATE, 0, 2, '회원', '신규 회원가입 후 첫 구매하신 고객님을 대상으로 18,000원 상당의 오호라 젤램프를 무료로 증정해 드리고 있습니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 회원정보를 변경하고 싶어요.', SYSDATE, 0, 2, '회원', '자사몰 회원가입 고객의 경우, 마이페이지 > 회원정보에서 정보 수정이 가능하나,
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. ID/PW가 기억이 안나요.', SYSDATE, 0, 2, '회원', '로그인 → 하단 아이디 찾기 → 이메일 또는 휴대폰 번호 선택 후 정보를 입력해주세요.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 리뷰(이용 후기) 운영 정책이 궁금합니다.', SYSDATE, 0, 2, '사이트 이용', '리뷰(이용 후기) 운영 정책은 아래와 같습니다.  
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 고객센터 이용 방법 알려주세요.', SYSDATE, 0, 2, '사이트 이용', '오호라 고객센터는 평일 9시부터 18시까지 채팅 상담으로 운영됩니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 오프라인 매장에서 오호라를 구매할 수 있나요?', SYSDATE, 0, 2, '기타', '오호라의 모든 제품은 온라인을 통해서만 구매하실 수 있으며,
...
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤램프] 오호라에서 판매중인 젤램프마다 차이는 무엇인가요?', SYSDATE, 0, 2, '상품', '이것은 fnp 본문 내용입니다.');
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 휴면 회원은 무엇인가요?', SYSDATE, 0, 2, '회원', '휴면 회원은 2015년 8월 18일부터 시행된 개인정보 유효 기간제에 따라 1년 이상 자사몰 접속 이력이 없는 회원을 대상으로 적용됩니다. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [커스텀젤] 사용기한이 정해져 있나요?', SYSDATE, 0, 2, '상품', '사용기한은 제조일로부터 2년으로 제품에 별도 표기되어있으며, 사용기한이 남아있더라도 개봉 후 1년 이내 사용을 권장합니다.');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [커스텀젤] 꼭 오호라 젤네일 위에 도포해야 하나요?', SYSDATE, 0, 2, '상품', '타사 젤 제품과 함께 사용 시 사용한 제품에 따라 호환성에 차이가 있을 수 있습니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [커스텀젤] 임산부 / 어린이가 사용해도 되나요?', SYSDATE, 0, 2, '상품', '임산부의 경우 전문의와 충분한 상의 후 사용하는 것을 권장합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [커스텀젤] 커스텀젤 사용 후 어떻게 보관해야 하나요?', SYSDATE, 0, 2, '상품', '반드시 뚜껑을 닫은 채로 직사광선을 피해 상온에서 보관해주세요.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [커스텀젤] 예쁘게 모양을 내는 팁이 있나요?', SYSDATE, 0, 2, '상품', '상세페이지의 드로잉 가이드를 토대로 원하는 형태의 디자인을 종이에 연습해보세요.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [커스텀젤] 탑젤을 먼저 바르고 커스텀젤을 사용해도 되나요?', SYSDATE, 0, 2, '상품', '커스텀젤을 먼저 도포하고 그 위에 탑젤은 얇게 바르는 것을 권장하고 있습니다');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [커스텀젤] 오호라 프로 포인트 젤램프가 아닌 일반 젤램프로 경화해도 되나요?', SYSDATE, 0, 2, '상품', '오호라 프로 포인트 젤램프로 경화 시, 손톱으로부터 3~4cm 떨어진 지점에서 도포 한 양에 따라 20초씩 1~2회 경화해주세요.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤스트립, 젤네일팁] 부착 기간이 정해져 있나요?', SYSDATE, 0, 2, '상품', '젤스트립, 젤네일팁은 부착 방법 및 손, 발톱 상태에 따라서 최대 2주 이상 유지될 수 있습니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 길이를 손톱에 맞게 잘라서(다듬어서) 사용이 가능한가요?', SYSDATE, 0, 2, '상품', '오호라 젤네일팁은 연장된 길이에 가장 예쁜 쉐입으로 만들어져 있어서 길이를 잘라서 조정할 시 설계된 쉐입이 틀어질 수 있습니다.

');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 탑젤을 사용해도 되나요?', SYSDATE, 0, 2, '상품', '네 가능합니다. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤램프] 오호라에서 판매하는 모든 젤램프로 경화가 가능한가요?', SYSDATE, 0, 2, '상품', '오호라 제품은 상품과 젤램프에 따라 적정 경화 횟수가 상이합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 오호라 프로 네일 프라이머 플러스 사용이 가능한가요?', SYSDATE, 0, 2, '상품', '네. 가능합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 어떻게 제거해야 하나요?', SYSDATE, 0, 2, '상품', '젤네일팁 본품 박스 내 동봉된 제거툴과, 이지필 리무버를 사용 시 효과적으로 젤네일 팁 제거가 가능합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 남은 젤네일팁은 어떻게 보관하나요?', SYSDATE, 0, 2, '상품', '1. 사용하고 남은 제품은 젤네일 팁 본품 박스 및 케이스에 넣어서 직사광선을 피해 그늘진 곳에 보관해주세요.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 어떻게 하면 손톱에 딱 맞는 사이즈를 찾을 수 있나요?', SYSDATE, 0, 2, '상품', '젤네일팁이 스트립에 붙어있는 상태에서 손톱에 대본 후, 손톱보다 살짝 작은(약 1~2mm) 사이즈를 골라주세요. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 경화를 하지 않고 사용해도 되나요?', SYSDATE, 0, 2, '상품', '젤네일팁은 실제 액상 젤로 만들어진 제품으로 필수적으로 마무리 과정에서 UV LED 젤램프를 이용해 경화를 해주셔야 합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 젤스트립과 젤네일팁의 차이점이 무엇인가요?', SYSDATE, 0, 2, '상품', '[젤스트립]
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 언더코트 성분이 어떻게 되나요?', SYSDATE, 0, 2, '상품', '[2024.06.19] [리뉴얼] 에틸아세테이트,부틸아세테이트,나이트로셀룰로오스,아디픽애씨드/네오펜틸글라이콜/트라이멜리틱안하이드라이드코폴리머,에탄올,아이소프로필알코올,수크로오스아세테이트아이소부티레이트,캠퍼,정제수,드로메트리졸
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 한 사이즈 작은 팁 사용을 추천하는 이유가 무엇인가요?', SYSDATE, 0, 2, '상품', '젤네일팁은 손톱 굴곡과 유사한 곡면으로 제작되어 눈으로 보는 것보다 실제 손톱에 부착했을 때 더 크게 느껴집니다.

따라서 실제 손톱보다 살짝 작은 사이즈를 부착하시면 더 예쁜 연출이 가능한 점 참고 부탁드립니다!');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 부착 후 커스텀젤 사용이 가능한가요?', SYSDATE, 0, 2, '상품', '네 가능합니다. 
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. [젤네일팁] 위에 파츠 사용이 가능한가요?', SYSDATE, 0, 2, '상품', '네 가능합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, null, 'Q. 환불 소요 기간은 어떻게 되나요?', SYSDATE, 0, 2, '교환/반품/환불', '주문하신 상품의 취소/반품이 완료된 이후 환불이 진행됩니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 주문 취소시 적립금과 쿠폰 환원은 어떻게 되나요?', SYSDATE, 0, 2, '주문/결제/취소', '주문 취소 또는 반품 시 적립금과 쿠폰은 정상적으로 환원됩니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 주문 취소 철회는 어떻게 할 수 있나요?', SYSDATE, 0, 2, '주문/결제/취소', '마이페이지 [주문 내역]에서 주문 취소 철회가 가능합니다.

환불이 완료 된 경우에는 철회가 불가능하며 재 주문 해주시기를 부탁드립니다.');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 결제 수단을 변경하고 싶어요.', SYSDATE, 0, 2, '주문/결제/취소', '시스템 상 결제 수단 변경이 불가능하여 주문 취소 후 재 구매 해주셔야 합니다

※카드사별 혜택 적용 및 할부 수수료, 할부 개월 수 변경은 카드사 고객센터로 문의 부탁드립니다.');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q.주문한 상품을 취소/변경 하고 싶어요.', SYSDATE, 0, 2, '주문/결제/취소', '주문의 상태에 따라 방법이 상이합니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 네이버페이로 주문했는데 주문 번호 확인이 되지 않아요.', SYSDATE, 0, 2, '주문/결제/취소', '네이버페이는 비회원 주문으로 오호라 공식 홈페이지에서 확인이 불가능 하며, 네이버페이 결제 내역에서 확인 가능합니다.');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 배송지 변경은 어떻게 하나요?', SYSDATE, 0, 2, '배송', '[결제 완료 및 상품 준비중 상태]
주문 취소 후 재 주문 부탁드립니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 언더코트는 어떻게 사용하나요?', SYSDATE, 0, 2, '상품', '손톱이 부착되지 않은 젤네일팁 부착면 여유 부위에 언더코트를 얇게 한 번만 바른 후 자연건조해주세요.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤램프] 젤램프 다리가 펴지지 않아요.', SYSDATE, 0, 2, '상품', '처음에는 다리와 본체가 꽉 결합되어 있기 때문에 쇠젓가락과 같은 얇은 도구로 지렛대 원리는 이용하여 조금만 힘을 주시면 펴 집니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤램프]오호라 프로 포터블 램프가 빨리 꺼져요/안 켜져요.', SYSDATE, 0, 2, '상품', '

프로 포터블 젤램프는 제품 안전 설계의 이유로 최초 사용시와 제품이 완전 방전시에 완전 충전이 된 후에 정상 작동이 되도록 설계되었습니다.

일반 어댑터 + 동봉P린 케이블로 초록불이 켜져 있는 점등 상태가 될 때 까지 충전 후 재 사용 부탁드립니다
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 불량 제품을 받았는데 어떻게 하나요?', SYSDATE, 0, 2, '교환/반품/환불', '불량 부분이 잘 보이는 사진 또는 영상 + 패키지 박스 하단 LOT.NO 사진 1장 촬영 후 고객 센터로 연락 주시면 불량 확인 후 빠르게 도움드리고 있습니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 비회원으로 주문했는데 주문 번호를 잊어버렸어요.', SYSDATE, 0, 2, '회원', '주문 시 입력한 휴대폰 번호와 이메일로 주문 처리 과정을 보내드리고 있습니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 오호라 보관함 사이즈가 어떻게 되나요?', SYSDATE, 0, 2, '상품', '오호라 보관함은 세미큐어젤과 케어 용품의 정리를 도와주는 아이템입니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. [젤스트립] 국가별 젤스트립 사이즈가 어떻게 되나요?', SYSDATE, 0, 2, '상품', '[KR/JP 젤스트립 사이즈]
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 네이버페이로 주문했는데 젤램프 사은품이 오지 않았어요.', SYSDATE, 0, 1, '주문/결제/취소', '젤램프 무료 증정 이벤트는 오호라 사이트 신규 회원 가입 회원님들을 대상으로 첫 구매 고객에 한하여 혜택이 적용되는 이벤트입니다.
비회원 구매인 네이버페이는 혜택 증정이 어려운 점 양해 부탁드립니다.');

INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 교환/반품을 하고 싶은 경우 어떻게 하면 되나요?', SYSDATE, 0, 1, '교환/반품/환불', '교환/반품은 사유에 따라 반품 가능 여부 및 배송비 부과가 다를 수 있습니다.
오호라 교환/반품 규정 안내드립니다.
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 반품 비용은 어떻게 되나요?', SYSDATE, 0, 1, '교환/반품/환불', '
1)무료 배송
...
INSERT INTO ohorafnqBoard (seq, writer, title, writedate, readed, tag, category, content) 
VALUES (ohorafnqseq.NEXTVAL, 'ohora', 'Q. 비회원 구매 시 첫 구매 혜택 적용이 안되나요?', SYSDATE, 0, 1, '회원', '비회원으로 구매하실 경우 첫 구매 혜택 적용이 되지 않습니다.
