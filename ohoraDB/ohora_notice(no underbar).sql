--게시판 공지 더미데이터
select *
from ohoranoticeBoard;


CREATE TAbLE ohoranoticeBoard (
...
CREATE SEQUENCE ohoranoticeseq 
    START WITH 1 
    INCREMENT BY 1 
    NOCACHE;
...
--insert문 예시
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, '관리자', '공지사항 제목 예시', SYSDATE, 0, 1, '이것은 공지사항 본문 내용입니다.');



--더미
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, null, '[공지] 2023년 휴면 회원 약관 개정 안내', SYSDATE, 0, 2, '2023 오호라 약관 개정 안내
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, 'ohora', '[공지] 포토 리뷰 적립금 변경 안내', SYSDATE, 0, 2, '고객님들께서 정성스럽게 작성해 주시는 포토&동영상 리뷰에 보답하고자 적립금을 상향 조정하게 되었습니다.
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, 'ohora', '[종료][6/17~6/28] 신제품 포토 리뷰 적립금 5,000점 지급 이벤트', SYSDATE, 0, 2, '[이벤트 참여 전 꼭 읽어주세요]
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, 'ohora', '[종료][6/24~7/1] 오호라 보관함 증정 이벤트', SYSDATE, 0, 2, '[이벤트 참여 전 꼭 읽어주세요]
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, null, '[공지]개인정보 처리방침 내 수탁업체 변경사항', SYSDATE, 0, 2, '2024 개인정보 처리방침 변경
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, 'ohora', '[7/8~7/15] 구매 금액대별 쿠폰팩 이벤트', SYSDATE, 0, 2, '[이벤트 참여 전 꼭 읽어주세요]
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, null, '[공지]친구 추천 프로모션 종료 안내', SYSDATE, 0, 2, '안녕하세요 오호라입니다.
...
감사합니다.');
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, 'ohora', '[공지]추석 연휴 배송 및 고객 상담 마감 안내', SYSDATE, 0, 1, '안녕하세요 고객님!
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, 'ohora', '[종료][10/7~10/14] 오호라 팝젤 증정 이벤트', SYSDATE, 0, 2, '[이벤트 참여 전 꼭 읽어주세요]
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, 'ohora', '[종료][10/14~10/28] 오호라 보관함 증정 이벤트', SYSDATE, 0, 2, '[이벤트 참여 전 꼭 읽어주세요]
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, 'ohora', 'ohora membership 오호라 멤버쉽 안내', SYSDATE, 0, 2, '이것은 공지사항 본문 내용입니다.');


INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, null, '[공지]개인정보 처리방침 내 수탁업체(택배사) 변경사항', SYSDATE, 0, 1, '2024 개인정보 처리방침 변경
...
INSERT INTO ohoranoticeBoard (seq, writer, title, writedate, readed, tag, content) 
VALUES (ohoranoticeseq.NEXTVAL, null, '[공지]개인정보 처리방침 변경 안내', SYSDATE, 0, 1, '2024 개인정보 처리방침 변경
