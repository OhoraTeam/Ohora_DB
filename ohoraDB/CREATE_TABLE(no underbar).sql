...
--리뷰댓글
CREATE SEQUENCE  OCOMMENTSEQ
START WITH 10
NOCACHE;
--회원번호 시퀀스
CREATE SEQUENCE SCOTT.OUSERSEQ
NOCACHE;
--주문번호 시퀀스
CREATE SEQUENCE OORDERSEQ
START WITH 10
NOCACHE;
--주문상세 시퀀스
CREATE SEQUENCE OORDDETAILSEQ
NOCACHE;
--회원 장바구니 시퀀스
CREATE SEQUENCE ADDCARTSEQ
NOCACHE;
--배송지 시퀀스
CREATE SEQUENCE OADDRSEQ
START WITH 1
INCREMENT BY 1
NOCACHE;
...
CREATE TABLE SCOTT.OUSER (
	...
	MEMID NUMBER, /* 멤버십 ID */
	AUTHID NUMBER, /* 권한 ID */
	USERLOGINID VARCHAR2(20) NOT NULL, /* 아이디 */
	...
	USERSNSAGREE CHAR(1) DEFAULT 'N', /* SNS수신동의 */
...
MODIFY pdtimgurl VARCHAR2(100 CHAR);

ALTER TABLE oproduct
MODIFY pdtimgurl2 VARCHAR2(100 CHAR);
